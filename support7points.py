...
def fitting_function7(par1, par2, par3):
    # --------------------------------------------------
    '''
    ...
    return Coefficient_F_c, temp4, temp5

def get_results(x, y, Coefficient):
    temp3 = np.zeros(6)
    temp = np.zeros(len(Coefficient))
    for i in range(len(Coefficient)):
        ...
        temp[i] = f([x, y])
    # temp is the value of the 7-points function
    return temp
